...
rule machine_learning_best_ensemble_bachem:
    input:
         ...
         phi_correlation_in="data/bachem/machine_learning/phi_correlation/phi_correlation_wl_{wl}.csv"
    output:
         ensemble_validation_out=\
             "data/bachem/machine_learning/ensemble_results_validated/ensemble_results_validated_wl_{wl}.csv",
         ensemble_validation_tuned_hp_out=\
             "data/bachem/machine_learning/ensemble_results_validated_tuned_hp/ensemble_results_validated_tuned_hp_wl_{wl}.csv",
         plot_cv_out=\
              expand("data/bachem/plots/best_model/best_model_cv_{tuning}_wl_{{wl}}.png", tuning=[0, 1]),
         ensemble_out=\
              expand("data/bachem/models/best_model/best_model_{tuning}_wl_{{wl}}.joblib", tuning=[0, 1]),
    params:
