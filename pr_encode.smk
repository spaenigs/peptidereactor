...
rule all:
    input:
         f"data/pds/plots/filtered_datasets.png",
...
rule meta_workflow_sequence_based_encodings:
    ...
    output:
         ...
         ngram_a2_lsv_out=\
              expand("data/{{normalized_dataset,.*?\d+}}/misc/ngram_a2/ngram_a2_lsv_{dim}.csv", dim=[1, 5, 20, 50, 100, 200, 300]),
         ngram_a2_sv_out=\
              expand("data/{{normalized_dataset,.*?\d+}}/misc/ngram_a2/ngram_a2_sv_{dim}.csv", dim=[1, 5, 20, 50, 100, 200, 300]),
         ngram_a3_out=\
              expand("data/{{normalized_dataset,.*?\d+}}/csv/ngram_a3/ngram_a3_{dim}.csv", dim=[1, 5, 20, 50, 100, 200, 300]),
         ngram_a3_lsv_out=\
              expand("data/{{normalized_dataset,.*?\d+}}/misc/ngram_a3/ngram_a3_lsv_{dim}.csv", dim=[1, 5, 20, 50, 100, 200, 300]),
         ngram_a3_sv_out=\
              expand("data/{{normalized_dataset,.*?\d+}}/misc/ngram_a3/ngram_a3_sv_{dim}.csv", dim=[1, 5, 20, 50, 100, 200, 300]),
         ngram_e2_out=\
              expand("data/{{normalized_dataset,.*?\d+}}/csv/ngram_e2/ngram_e2_{dim}.csv", dim=[1, 5, 20, 50, 100, 200, 300]),
         ngram_e2_lsv_out=\
              expand("data/{{normalized_dataset,.*?\d+}}/misc/ngram_e2/ngram_e2_lsv_{dim}.csv", dim=[1, 5, 20, 50, 100, 200, 300]),
         ngram_e2_sv_out=\
              expand("data/{{normalized_dataset,.*?\d+}}/misc/ngram_e2/ngram_e2_sv_{dim}.csv", dim=[1, 5, 20, 50, 100, 200, 300]),
         ngram_e3_out=\
              expand("data/{{normalized_dataset,.*?\d+}}/csv/ngram_e3/ngram_e3_{dim}.csv", dim=[1, 5, 20, 50, 100, 200, 300]),
         ngram_e3_lsv_out=\
              expand("data/{{normalized_dataset,.*?\d+}}/misc/ngram_e3/ngram_e3_lsv_{dim}.csv", dim=[1, 5, 20, 50, 100, 200, 300]),
         ngram_e3_sv_out=\
              expand("data/{{normalized_dataset,.*?\d+}}/misc/ngram_e3/ngram_e3_sv_{dim}.csv", dim=[1, 5, 20, 50, 100, 200, 300]),
         ngram_s2_out=\
              expand("data/{{normalized_dataset,.*?\d+}}/csv/ngram_s2/ngram_s2_{dim}.csv", dim=[1, 5, 20, 50, 100, 200, 300]),
         ngram_s2_lsv_out=\
              expand("data/{{normalized_dataset,.*?\d+}}/misc/ngram_s2/ngram_s2_lsv_{dim}.csv", dim=[1, 5, 20, 50, 100, 200, 300]),
         ngram_s2_sv_out=\
              expand("data/{{normalized_dataset,.*?\d+}}/misc/ngram_s2/ngram_s2_sv_{dim}.csv", dim=[1, 5, 20, 50, 100, 200, 300]),
         ngram_s3_out=\
              expand("data/{{normalized_dataset,.*?\d+}}/csv/ngram_s3/ngram_s3_{dim}.csv", dim=[1, 5, 20, 50, 100, 200, 300]),
         ngram_s3_lsv_out=\
              expand("data/{{normalized_dataset,.*?\d+}}/misc/ngram_s3/ngram_s3_lsv_{dim}.csv", dim=[1, 5, 20, 50, 100, 200, 300]),
         ngram_s3_sv_out=\
              expand("data/{{normalized_dataset,.*?\d+}}/misc/ngram_s3/ngram_s3_sv_{dim}.csv", dim=[1, 5, 20, 50, 100, 200, 300]),
         cgr_out=\
...
rule plot_empty_datasets_pds:
    input:
         sequence_based_encodings=f"data/pds/csv/sequence_based/",
         structure_based_encodings=f"data/pds/csv/structure_based/"
    output:
         png_out=f"data/pds/plots/filtered_datasets.png"
    params:
         snakefile="nodes/plots/empty_datasets/Snakefile",
         configfile="nodes/plots/empty_datasets/config.yaml"
    run:
         with WorkflowExecuter(dict(input),
                               dict(output),
                               params.configfile,
                               datasets=[ds for ds in DATASETS if "pds" in ds],
                               cores=CORES) as e:
             shell(f"""{e.snakemake} -s {{params.snakefile}} --configfile {{params.configfile}}""")
