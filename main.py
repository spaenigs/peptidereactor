...
with WorkflowSetter(cores=CORES, benchmark_dir="data/{dataset}/misc/benchmark/") as w:
    ...
    w.add(benchmark.similarity.rule(
        ...
        corr_dir_out="data/{dataset}/benchmark/diversity/seq_vs_str/", benchmark_dir=w.benchmark_dir))
    ...
    w.add(benchmark.similarity.rule(
        ...
        corr_dir_out="data/{dataset}/benchmark/diversity/all_vs_all/", benchmark_dir=w.benchmark_dir))
    ...
    target = \
        ...
        expand("data/{dataset}/benchmark/diversity/seq_vs_str/", dataset=DATASETS) #+ \
        # expand("data/{dataset}/benchmark/diversity/all_vs_all.csv", dataset=DATASETS)
