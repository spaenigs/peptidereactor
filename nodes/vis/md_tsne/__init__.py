...
def _get_main(fastas_in, classes_in, html_dir_out):
    ...
    threads:
         1000
    params:
         snakefile="nodes/vis/md_tsne/Snakefile",
         configfile="nodes/vis/md_tsne/config.yaml"
    run:
...
def rule(fastas_in, classes_in, html_dir_out, benchmark_dir=None):
    ...
    if benchmark_dir is not None:
        benchmark_out = f"{benchmark_dir}vis_md_tsne_{token}.txt"
