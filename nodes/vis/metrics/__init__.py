...
def _get_main(metrics_dir_in, html_dir_out):
    ...
    threads:
         1000
    params:
         snakefile="nodes/vis/metrics/Snakefile",
         configfile="nodes/vis/metrics/config.yaml"
    run:
...
def rule(metrics_dir_in, html_dir_out, benchmark_dir=None):
    ...
    if benchmark_dir is not None:
        benchmark_out = f"{benchmark_dir}vis_metrics_{token}.txt"
