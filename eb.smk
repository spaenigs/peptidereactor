...
rule all:
    input:
         ...
         expand("data/{normalized_dataset}/csv/apaac/apaac_lambda_{lambda_val}.csv",
                normalized_dataset=NORMALIZED_DATASETS, lambda_val=list(range(1, 31))),
         expand("data/{normalized_dataset}/csv/cksaagp/cksaagp_gap_{gap_val}.csv",
                normalized_dataset=NORMALIZED_DATASETS, gap_val=list(range(1, 31))),
         expand("data/{normalized_dataset}/csv/socnumber/socnumber_nlag_{nlag_val}.csv",
                normalized_dataset=NORMALIZED_DATASETS, nlag_val=list(range(1, 31))),
         ...
         expand("data/{normalized_dataset}/csv/eaac/eaac_window_{window_val}.csv",
                normalized_dataset=NORMALIZED_DATASETS, window_val=list(range(1, 31))),
         ...
         expand("data/{normalized_dataset}/csv/fft/fft_{aaindex}.csv",
                normalized_dataset=NORMALIZED_DATASETS, aaindex=get_aaindex()),
         ...
         expand("data/{normalized_dataset}/csv/ngram_a2/ngram_a2_{dim}.csv",
                normalized_dataset=NORMALIZED_DATASETS, dim=[1, 5, 20, 50, 100, 200, 300]),
...
# expand("data/{normalized_dataset}/seqs_msa.fasta", normalized_dataset=NORMALIZED_DATASETS),
# expand("data/{normalized_dataset}/annotated_seqs.fasta", normalized_dataset=NORMALIZED_DATASETS),
# expand("data/{normalized_dataset}/annotated_seqs_msa.fasta", normalized_dataset=NORMALIZED_DATASETS),
# expand("data/{normalized_dataset}/annotated_classes.txt", normalized_dataset=NORMALIZED_DATASETS),
# expand("data/{normalized_dataset}/profile/", normalized_dataset=NORMALIZED_DATASETS),
# expand("data/{normalized_dataset}/misc/{encoding}.yaml",
#         normalized_dataset=NORMALIZED_DATASETS,
#         encoding=["ksctriad", "moran", "nmbroto", "geary", "qsorder", "socnumber", "eaac", "cksaagp",
#                   "cksaap", "apaac", "paac"]),
# expand("data/{normalized_dataset}/annotated_pdbs_seqs.fasta", normalized_dataset=NORMALIZED_DATASETS),
# expand("data/{normalized_dataset}/annotated_pdbs_classes.txt", normalized_dataset=NORMALIZED_DATASETS),
# expand("data/{normalized_dataset}/pdb/", normalized_dataset=NORMALIZED_DATASETS),
# expand("data/{normalized_dataset}/misc/ngram_{type}{size}.yaml",
#        normalized_dataset=NORMALIZED_DATASETS, type=["a","e","s"], size=[2,3]),
